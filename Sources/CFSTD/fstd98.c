...
static void print_std_parms(
    ...
    if (strstr(option, "GRIDINFO")) {
        ...
        // NOTE PZ: disabled
        /*igapg_(cracked.gtyp, pg1, pg2, pg3, pg4, &ig1, &ig2, &ig3, &ig4,
                    lc1, lc2, lc3, lc4, lc5);*/
                /*     1, 7, 7, 8, 8);       */
            ...
            case 5: case 8: case 133:  case 136:
                /* IEEE and IEEE complex representation */
                {
                    ...
                    if (datyp == 133) {
                        ...
                        if (compressed_lng < 0) {
                            stdf_entry->datyp = 5;
                            //PZ DISABLED: ieeepak_(field, &(buffer->data[keys_len]), &f_ni, &f_njnk, &f_minus_nbits,
                            //PZ DISABLED:     &f_zero, &f_one);
                        } else {
                            int nbytes = 16 + compressed_lng;
                            nw = (nbytes * 8 + 63) / 64;
                            nw = W64TOWD(nw);
        ...
        switch (stdf_entry.datyp) {
            ...
            case 8: {
                ...
                if ((downgrade_32) && (stdf_entry.nbits == 64)) {
                    ...
                    int32_t f_zero = 0;
                    int32_t f_mode = 2;
                    //PZ DISABLED: ieeepak_(field, buf->data, &nelm, &f_one, &npak, &f_zero, &f_mode);
                }
...
int c_fstopc(
  ...
  if (strcmp(option, "MSGLVL") == 0) {
    if (getmode){
        //PZ DISABLED:  if (getmode == 2) val = App->LogLevel[APP_LIBFST];
    }else{
       val=Lib_LogLevel(APP_LIBFST,value);
    }
      //PZ DISABLED: if (getmode == 1)
      //PZ DISABLED:   Lib_Log(APP_LIBFST,APP_INFO,"%s: option 'MSGLVL' , %d\n",__func__,App->LogLevel[APP_LIBFST]);
    return val;
  }
...
int c_fstopi(
  ...
  if (strcmp(option, "MSGLVL") == 0) {
    ...
    if (getmode){
        ...
        //PZ DISABLED:  App->LogLevel[APP_LIBFST]=value;
    }
      //PZ DISABLED: if (getmode == 1)
      //PZ DISABLED:    Lib_Log(APP_LIBFST,APP_INFO,"%s: option 'MSGLVL' , %d\n",__func__,App->LogLevel[APP_LIBFST]);
    return val;
...
/*int32_t fstcvt_(
    ...
    return (int32_t) fstcvt2_(name, type, etik, grtyp, cname, ctype, cetik, cgrtyp, holocar, l1, l2, l3, l4);
}*/
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fst_data_length_(int *f_length_type)
{
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstecr_s_(void *string, int32_t *work, int32_t *f_npak,
...
if (ninjnk > lng_string * *f_nj) {
  ...
  {
    ier = fstecr_(string, work, f_npak, f_iun, f_date, f_deet, f_npas, f_ni, f_nj, f_nk, f_ip1, f_ip2, f_ip3,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fsteff_(int32_t *f_handle)
{
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstinfx_(int32_t *f_handle, int32_t *f_iun,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstinl_(int32_t *f_iun, int32_t *f_ni, int32_t *f_nj,
                        int32_t *f_nk, int32_t *f_datev, char *f_etiket,
                        int32_t *f_ip1, int32_t *f_ip2, int32_t *f_ip3,
                        char *f_typvar, char *f_nomvar,
...
int32_t fstlic_(uint32_t *field, int32_t *f_iun,
                         int32_t *f_ni, int32_t *f_nj,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstlir_(int32_t *field, int32_t *f_iun,
                        int32_t *f_ni, int32_t *f_nj,
                        int32_t *f_nk, int32_t *f_datev, char *f_etiket,
                        int32_t *f_ip1, int32_t *f_ip2, int32_t *f_ip3,
                        char *f_typvar, char *f_nomvar,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstlir_s_(void *string, int32_t *f_iun,
                        int32_t *f_ni, int32_t *f_nj,
                        int32_t *f_nk, int32_t *f_datev, char *f_etiket,
                        int32_t *f_ip1, int32_t *f_ip2, int32_t *f_ip3,
                        char *f_typvar, char *f_nomvar,
                        int lng_string, F2Cl ll1, F2Cl ll2, F2Cl ll3)
{
  ...
  for (i = 0; i < lng_string; i++)
    *ptr++ = ' ';
  ier = fstlir_(string, f_iun, f_ni, f_nj, f_nk, f_datev, f_etiket,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstlir_h_(void *haft_w, int32_t *f_iun,
                        int32_t *f_ni, int32_t *f_nj,
                        int32_t *f_nk, int32_t *f_datev, char *f_etiket,
                        int32_t *f_ip1, int32_t *f_ip2, int32_t *f_ip3,
                        char *f_typvar, char *f_nomvar,
                        F2Cl ll1, F2Cl ll2, F2Cl ll3)
{
  ...
  xdf_short = 1;
  ier = fstlir_(haft_w, f_iun, f_ni, f_nj, f_nk, f_datev, f_etiket,
                     f_ip1, f_ip2, f_ip3, f_typvar, f_nomvar, ll1, ll2, ll3);
  xdf_short = 0;
  return ier;
}
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstlir_b_(void *bytes, int32_t *f_iun,
                        int32_t *f_ni, int32_t *f_nj,
                        int32_t *f_nk, int32_t *f_datev, char *f_etiket,
                        int32_t *f_ip1, int32_t *f_ip2, int32_t *f_ip3,
                        char *f_typvar, char *f_nomvar,
                        F2Cl ll1, F2Cl ll2, F2Cl ll3)
{
  ...
  xdf_byte = 1;
  ier = fstlir_(bytes, f_iun, f_ni, f_nj, f_nk, f_datev, f_etiket,
                     f_ip1, f_ip2, f_ip3, f_typvar, f_nomvar, ll1, ll2, ll3);
  xdf_byte = 0;
  return ier;
}
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstlirx_(uint32_t *field, int32_t *f_handle, int32_t *f_iun,
                        int32_t *f_ni, int32_t *f_nj,
                        int32_t *f_nk, int32_t *f_datev, char *f_etiket,
                        int32_t *f_ip1, int32_t *f_ip2, int32_t *f_ip3,
                        char *f_typvar, char *f_nomvar,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstlis_(uint32_t *field, int32_t *f_iun,
                        int32_t *f_ni, int32_t *f_nj, int32_t *f_nk)
{
  int iun = *f_iun;
  int ier, ni, nj, nk;
...
int32_t fstluk_(uint32_t *field, int32_t *f_handle,
                        int32_t *f_ni, int32_t *f_nj, int32_t *f_nk)
{
  int handle = *f_handle;
  int ier, ni, nj, nk;
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstmsq_(int32_t *f_iun, int32_t *f_mip1, int32_t *f_mip2,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstnbrv_(int32_t *f_iun)
{
  int iun = *f_iun;
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstopc_(char *f_option, char *f_value, int32_t *f_getmode,
                        F2Cl ll1, F2Cl ll2)
{
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstopi_(char *f_option, int32_t *f_value, int32_t * f_getmode,
                        F2Cl ll1)
{
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstopl_(char *f_option, int32_t *f_value, int32_t * f_getmode,
                        F2Cl ll1)
{
  int getmode = *f_getmode, value = *f_value, ier;
  int l1 = ll1;
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstopr_(char *f_option, float *f_value, int32_t * f_getmode,
                        F2Cl ll1)
{
  int getmode = *f_getmode, ier;
  float value = *f_value;
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstcheck_(char *filename, F2Cl lng)
{
  int ier;
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstouv_(int32_t *f_iun, char *options, F2Cl lng)
{
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstprm_(int32_t *f_handle,
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstskp_(int32_t *f_iun, int32_t *f_nrec)
{
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstvoi_(int32_t *f_iun, char *f_options, F2Cl ll1)
{
    char options[80] =
    {' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
    ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ',
 ...
 *                                                                           *
 *****************************************************************************/
int32_t fstweo_(int32_t *f_iun, int32_t *f_level)
{
...
int32_t ip2_all_(float *f_level, int32_t *f_kind)
{
  int kind = *f_kind, ip2;
  float level = *f_level;
...
int32_t ip3_all_(float *f_level, int32_t *f_kind)
{
  int kind = *f_kind, ip3;
  float level = *f_level;
...
int32_t ip1_val_(float *f_level, int32_t *f_kind)
{
  int kind = *f_kind, ip1;
  float level = *f_level;
...
int32_t ip2_val_(float *f_level, int32_t *f_kind)
{
  int kind = *f_kind, ip2;
  float level = *f_level;
...
int32_t ip3_val_(float *f_level, int32_t *f_kind)
{
  int kind = *f_kind, ip3;
  float level = *f_level;

...
int32_t float_unpacker_(float *dest, int32_t *header, int32_t *stream, int32_t *npts, int32_t *nbits)
{
...
int32_t float_packer_(float *source, int32_t *nbits, int32_t *header, int32_t *stream, int32_t *npts)
{
...
void float_packer_params_(int32_t *header_size, int32_t *stream_size, int32_t *p1, int32_t *p2, int32_t *npts)
{
...
main()
{
  ...
  float_packer_params_(&header_size, &stream_size, &p1, &p2, &npts);
  ...
  float_packer_(source, &nbits, header, stream, &npts);

  float_unpacker_(source2, header, stream, &npts, &NBITS);
  ...
  for ( j=0 ; j< 99 ; j++ ) {     /* perform repacking-unpacking cycles to verify stability */
    float_packer_(source2, &nbits, header, stream, &npts);
/*

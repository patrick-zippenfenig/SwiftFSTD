...
int32_t xdfopn_(int32_t *fiun, char *mode, ftnword_2 *pri, int32_t *fnpri,
...
int32_t xdfcls_(int32_t *fiun);
int c_xdfcls(int iun);
int32_t xdfsta_(int32_t *fiun, int32_t *stat, int32_t *fnstat,
...
int c_xdfsta(int iun, uint32_t *stat, int nstat,
                    ...
                    char *vers, char *appl);
int32_t xdfimp_(int32_t *fiun, int32_t *stat, int32_t *fnstat,
                    ftnword_2 *pri, ftnword_2 *aux,
                    char *vers, char *appl, F2Cl l1, F2Cl l2);
int c_xdfimp(int iun, uint32_t *stat, int nstat, word_2 *pri, word_2 *aux,
                    char *vers, char *appl);
int32_t xdfini_(int32_t *fiun, uint32_t *buf, int32_t *fidtyp,
...
int32_t xdfget_(int32_t *fhandle, uint32_t *buf);
...
int32_t xdfput_(int32_t *fiun, int32_t *fhandle,
            uint32_t *buf);
int c_xdfput(int iun, int handle, buffer_interface_ptr buf);
int32_t xdfopt_(char *foptname, char *foptc, int32_t *foptv,
            F2Cl l1, F2Cl l2);
int c_xdfopt(char *optname, char *optc, int optv);
int32_t xdfgop_(char *foptname, char *foptc, int32_t *foptv,
            F2Cl l1, F2Cl l2);
int c_xdfgop(char *optname, char *optc, int *optv);
int32_t xdfins_(uint32_t *buf, uint32_t *donnees,
...
int32_t qdfmsig_(int32_t *fiun, char *appl, F2Cl l1);
int32_t xdflnk_(int32_t *liste, int32_t *fn);
int32_t secateur_(char *filename, int32_t *f_where, F2Cl l1);

...
void *compact_float(
    ...
    float missingValueTag = *((float *)missingTag);
    ...
    if ( opCode == FLOAT_PACK ) {
        ...
        arrayOfFloat = (float *)unpackedArrayOfFloat;
        ...
        ************************************************************************/
...

        {
            ...
            int32_t expos_ftn;
            expos_ftn = tempExpo;
            mulFactor = powerOf2s[packedTokenBS] / powf(two, expos_ftn);
        }
